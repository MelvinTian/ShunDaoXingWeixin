 ...
 */
public class RicfitListDialogWhiteBG
{
		...
		public RicfitListDialogWhiteBG(Context context,List<String> data)
		{
		...
		public void show(boolean isCenter)
		{
			...
			window.setContentView(R.layout.listview_dialog_white);
			...
			if(isCenter){
				adapter=new ArrayAdapter<String>(context, R.layout.listview_dialog_item_white,R.id.listview_dialog_item_text, data);
			}else{
				adapter=new ArrayAdapter<String>(context, R.layout.listview_dialog_item_white,R.id.listview_dialog_item_text, data);
			}
		 ...
		 */
		public RicfitListDialogWhiteBG getSonforum(OnItemClickListener listener){
			if(listener==null){
