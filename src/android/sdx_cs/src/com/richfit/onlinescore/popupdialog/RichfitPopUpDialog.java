 ...
 * @日期： 2014年9月10日-下午4:25:26
 */
public class RichfitPopUpDialog
{
	...
	public RichfitPopUpDialog(Context context)
	{
	 ...
	 * @param id
	 */
	public RichfitPopUpDialog setImageTip(int resID)
	{
	 ...
	 * @param id
	 */
	public RichfitPopUpDialog setImageTip(Bitmap bm)
	{
	 ...
	 * @param content
	 */
	public RichfitPopUpDialog setContent(String content)
	{
		this.strTip = content;
		return this;
	}
	 ...
	 * @param listener
	 */
	public RichfitPopUpDialog setPositiveButton(CharSequence text, OnClickListener listener)
	{
	 ...
	 * @param listener
	 */
	public RichfitPopUpDialog setNegativeButton(CharSequence text, OnClickListener listener)
	{
