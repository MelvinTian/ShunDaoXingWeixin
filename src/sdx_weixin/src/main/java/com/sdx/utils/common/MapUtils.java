...
public final class MapUtils
{
    ...
    public static SortMaintainMap<String, String> getSortMaintainMap(String... args)
    {
        SortMaintainMap<String, String> targetMap = new SortMaintainMap<String, String>();
        int length = args.length / 2 * 2;
        for (int i = 0; i < length; i++)
        {
            targetMap.put(args[i++], args[i]);
        }
        return targetMap;
    }
}
