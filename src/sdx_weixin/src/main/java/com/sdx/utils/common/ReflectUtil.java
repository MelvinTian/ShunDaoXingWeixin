        ...
        try
        {
            ...
            for (int i = 0; i < fields.length; i++)
            {
                ...
                if (field.getName().equals(fieldName))
                {
                    ...
                    String firstLetter = fieldName.substring(0, 1).toUpperCase(); // 获得和属性对应的getXXX()方法的名�?
                    if ("set".equals(type))
                    {
                    ...
                    if ("get".equals(type))
                    {
                        String getMethodName = "get" + firstLetter + fieldName.substring(1); // 获得和属性对应的setXXX()方法的名�?
